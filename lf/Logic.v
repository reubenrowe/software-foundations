...
Proof.
  ...
  - destruct m.
    + reflexivity.
    + unfold plus in H. destruct n. discriminate. discriminate.
Qed.
(** [] *)
...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros P notP Q P_witness.
  unfold not in notP.
  apply notP in P_witness as contra.
  destruct contra.
Qed.
(** [] *)
...
Proof.
  ...
  unfold not.
  intros witnessP.
  apply H in witnessP as witnessQ.
  unfold not in notQ.
  apply notQ.
  apply witnessQ.
Qed.
...
Proof.
  ...
  apply H in witnessP as witnessQ.
  unfold not in notQ.
  apply notQ in witnessQ as contra.
  apply contra.
Qed.
...
Proof.
  ...
  split.
  - intros witnessP. apply HQR. apply HPQ. apply witnessP.
  - intros witnessR. apply HQP. apply HRQ. apply witnessR. 
Qed.
(** [] *)
...
Proof.
  intros P Q R.
  split.
  - intros [witnessP | [witnessQ witnessR]].
    + split.
      * left. apply witnessP.
      * left. apply witnessP.
    + split.
      * right. apply witnessQ.
      * right. apply witnessR.
  - intros [PorQ PorR].
    destruct PorQ as [ witnessP | witnessQ ].
    + left. apply witnessP.
    + destruct PorR as [ witnessP | witnessR ].
      * left. apply witnessP.
      * right. split.
        { apply witnessQ. }
        { apply witnessR. }
...
Proof.
  ...
  - split.
    ...
    + intros [ H1 H2 ] x' [ Hhead | HTail ].
      * rewrite <- Hhead. apply H1.
      * rewrite <- IH in H2. apply H2. apply HTail.
Qed.
(** [] *)
...
Proof.
  intros Podd Peven n H_odd H_even.
...
Lemma rev_append_app : forall X (l l1 l2 : list X),
...
Proof.
  ...
  - rewrite even_S.
    destruct IH as [ k IH ].
    destruct (even n').
    + exists k. rewrite IH. reflexivity.
...
Proof.
  ...
  - destruct b2.
    + simpl. split.  
        { intros H. split. apply H. reflexivity. }
        { intros [ H _ ]. apply H. }
    + simpl. split.
        { intros H. split. apply H. apply H. }
        { intros [ H _ ]. apply H. }
Qed.
...
Proof.
  ...
  unfold not.
  split.
  - intros H1 H2. apply H1. rewrite H2. apply eqb_refl.
  - intros H1 H2. apply H1. apply eqb_true. apply H2.
Qed.  
...
Lemma de_morgan_not_or : forall P Q, (~ (P \/ Q)) <-> ~P /\ ~Q.
Proof.
  intros. unfold not.
  split.
  - intros H.
    split.
    * intros witnessP. apply H. left. apply witnessP.
    * intros witnessQ. apply H. right. apply witnessQ. 
  - intros [ notP notQ ] [ witnessP | witnessQ ].
    * apply notP. apply witnessP.
    * apply notQ. apply witnessQ.
Qed.
...
Proof.
  ...
  assert
    ...
    {
      split.
      - intros witness. apply H. left. apply witness.
      - intros witness. apply H. right. apply witness.
    }
  destruct de_morgan as [ notP notnotP ].
  apply notnotP.
  apply notP.
Qed.
(** [] *)
...
Proof.
  ...
  - intros. apply HP.
  - destruct (em Q) as [ HQ | HQ ].
    * intros H. apply H. intros. apply HQ.
    * intros H. apply H. intros HP'. exfalso. apply HP. apply HP'.  
Qed.

Theorem perice_dne : peirce -> double_negation_elimination.
Proof.
  intros Peirce P nnP.
...
Theorem dmnan_implies_to_or : de_morgan_not_and_not -> implies_to_or.
Proof.
  intros dmnan P Q H.
  apply dmnan.
  unfold not.
...
Theorem implies_to_or_em : implies_to_or -> excluded_middle.
Proof.
  intros ito P.
  apply or_commut.
  apply (ito P P).
